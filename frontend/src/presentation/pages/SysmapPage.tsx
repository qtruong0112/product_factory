...
const RELATIONS: { source: string; verb: string; target: string; card: string }[] = [
  ...
  { source: 'Obligation Element', verb: 'cấu thành', target: 'Obligation Type', card: 'N:1' },
  { source: 'Obligation Type', verb: 'gom nhóm', target: 'Obligation Family', card: 'N:1' },
  { source: 'Obligation Type', verb: 'thuộc', target: 'Financial Obligation Archetype', card: 'N:1' },
  ...
  { source: 'Product Pattern', verb: 'gán', target: 'Obligation Type', card: 'N:N' },
