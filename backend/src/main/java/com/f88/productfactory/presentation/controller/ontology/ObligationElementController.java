...
import com.f88.productfactory.application.service.ontology.ObligationElementService;
...
public class ObligationElementController {
    ...
    private final ObligationElementService service;

    public ObligationElementController(ObligationElementService service) {
